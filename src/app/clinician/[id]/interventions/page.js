...
export default function InterventionsPage({ params }) {
  const { id } = use(params);
    ...
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <section className="bg-white rounded-lg shadow p-6">
          ...
          <div className="h-48 bg-gray-100 rounded flex items-center justify-center text-gray-400">Data Table Placeholder</div>
        </section>
      </div>
    </div>
  );
