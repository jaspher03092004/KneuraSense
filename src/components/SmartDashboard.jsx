...
const StatusBadge = ({ icon: Icon, label, value, isOnline }) => (
  <div className="flex items-center gap-3 bg-white dark:bg-slate-900 px-4 py-2.5 rounded-lg border border-slate-200 dark:border-slate-800 shadow-sm transition-colors duration-300">
    <Icon size={18} className={`transition-colors duration-300 ${isOnline ? "text-emerald-500 dark:text-emerald-400" : "text-slate-400 dark:text-slate-500"}`} />
    ...
    <div className="space-y-6 max-w-7xl mx-auto transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="lg:col-span-4 xl:col-span-4 bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-8 flex flex-col items-center justify-center relative overflow-hidden transition-colors duration-300">
              ...
              <svg className="w-full h-full overflow-visible" viewBox="0 0 200 110" preserveAspectRatio="xMidYMax meet">
                ...
                <path d="M 20 100 A 80 80 0 0 1 180 100" fill="none" 
                  className={`transition-all duration-1000 ease-out ${
                    data.risk_score > 70 ? 'text-rose-500 dark:text-rose-400' : data.risk_score > 40 ? 'text-amber-500 dark:text-amber-400' : 'text-emerald-500 dark:text-emerald-400'
                  }`}
           ...
           <div className="mt-6 text-center">
              ...
              <span className={`inline-flex items-center gap-1.5 mt-3 px-4 py-1.5 text-sm font-bold rounded-full border transition-colors duration-300 ${
                  data.risk_score > 70 ? 'bg-rose-50 dark:bg-rose-500/10 text-rose-600 dark:text-rose-400 border-rose-200 dark:border-rose-500/20' : 
                  data.risk_score > 40 ? 'bg-amber-50 dark:bg-amber-500/10 text-amber-600 dark:text-amber-400 border-amber-200 dark:border-amber-500/20' : 'bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-200 dark:border-emerald-500/20'
              }`}>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 p-5 flex flex-col md:flex-row items-center justify-between gap-4 transition-colors duration-300">
         ...
         <div className="flex items-center gap-3 bg-slate-50 dark:bg-slate-800 px-4 py-2 rounded-xl border border-slate-100 dark:border-slate-700 w-full md:w-auto transition-colors duration-300">
            <Cloud size={20} className="text-slate-400 dark:text-slate-500 transition-colors duration-300" />
            <div>
